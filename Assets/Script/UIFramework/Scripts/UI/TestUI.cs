...
{
    public TestUIDataComponent uicompt = new TestUIDataComponent();
...
#region UI组件事件  
	...
	public void OnpwdInputChange(string text)
	{
		
	}

	public void OnpwdInputEnd(string text)
	{
